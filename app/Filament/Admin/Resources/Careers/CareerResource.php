...
namespace App\Filament\Admin\Resources\Careers;

use App\Filament\Admin\Resources\Careers\Pages\ManageCareers;
...
class CareerResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                \Filament\Forms\Components\Section::make('Career Details')
                    ->schema([
